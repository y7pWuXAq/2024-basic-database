...
-- Q5. 도서의 가격(Book테이불)과 판매가격(Orders테이블)의 차이가 가장 많은 주문
...
-- Q6. 도서 판매액 평균보다 자신의 구매액 평균이 더 높은 고객의 이름
